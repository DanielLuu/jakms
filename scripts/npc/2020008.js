...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            if (cm.getQuestStatus(6192).equals(Packages.net.sf.odinms.client.MapleQuestStatus.Status.STARTED)) {
            ...
            } else if (cm.getQuestStatus(6192).equals(Packages.net.sf.odinms.client.MapleQuestStatus.Status.STARTED) == false) {

//carta
function start(){
    if(cm.getChar().getQuest(Packages.net.sf.odinms.server.quest.MapleQuest.getInstance(6301)).getStatus().equals(Packages.net.sf.odinms.client.MapleQuestStatus.Status.STARTED)) {

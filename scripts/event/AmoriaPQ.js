...
function playerEntry(eim, player) {
	...
	//THE CLOCK IS SHIT
	player.getClient().getSession().write(Packages.net.sf.odinms.tools.MaplePacketCreator.getClock(3600));
}
...
function clearPQ(eim) {
	...
	var iter = eim.getPlayers().iterator();
        ...
        while (iter.hasNext()) {
	        ...
	        player.getClient().getSession().write(Packages.net.sf.odinms.tools.MaplePacketCreator.getClock(120));
		}
